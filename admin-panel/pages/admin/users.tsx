    ...
    <Layout title="Users">
      ...
      <header className="flex items-center justify-between mb-4 gap-3 flex-wrap">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-slate-400">Manage all registered users and their credits</p>
        </div>
      ...
      <section className="bg-gradient-to-br from-slate-900/90 to-slate-950 rounded-[18px] border border-slate-700/35 p-4 shadow-[0_18px_45px_rgba(15,23,42,0.8)]">
        ...
        <div className="bg-gradient-to-br from-orange-500/8 to-slate-950 rounded-lg p-6 border border-slate-700/30">
          <p className="text-slate-300 mb-2">User management interface coming soon.</p>
          <p className="text-xs text-slate-500">
            This will show all users, allow adding credits, promoting admins, etc.
          </p>
        </div>
      </section>
    </Layout>
